...
public class OptionsUI : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        soundEffectButton.onClick.AddListener(() => { 
            SoundManager.Instance.ChangedVolum();
            UpdateVisual();
        });

        musicButton.onClick.AddListener(() => { 
            MusicManager.Instance.ChangedVolum();
           UpdateVisual();
        });
    ...
    private void Start()
    {
        KitchenGameManager.Instance.OnLocalGamePaused += KitchenGameManager_OnGamePause;
    ...
    {
        // 1. Lưu lại "hành động" mà PauseUI đã đưa cho
        this.onCloseButtonAction = onCloseButtonAction;

        // 2. Hiện giao diện OptionsUI lên
